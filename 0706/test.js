...
function box_2F_data(ID,father_ID){
  switch (father_ID) {
    ...
    // 營收總覽
    case "YingShouZongLan":{alert(father_ID+"的"+ID);page_change_2F({father_ID,ID});break;};
    // 漲跌總覽
    case "JhangDieZongLan":{alert(father_ID+"的"+ID);page_change_2F({father_ID,ID});break;};
    // 產業指數
